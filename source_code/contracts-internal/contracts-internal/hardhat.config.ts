...
export default {
  ...
  networks: {
    ...
    [eAstarLayer2Network.zkatana]: getCommonNetworkConfig(
      eAstarLayer2Network.zkatana,
      1261120
    ),
    [eScrollNetwork.mainnet]: getCommonNetworkConfig(
      eScrollNetwork.mainnet,
      534352
    ),
    [eScrollNetwork.testnet]: getCommonNetworkConfig(
