...
const func: DeployFunction = async function ({
  ...
  if (!(await getInitConfiguration(aToken.address))) {
    await waitForTx(
    ...
    await saveInitConfiguration(aToken.address);
  }
  ...
  if (!(await getInitConfiguration(delegationAwareAToken.address))) {
    await waitForTx(
    ...
    await saveInitConfiguration(delegationAwareAToken.address);
  }
  ...
  if (!(await getInitConfiguration(stableDebtToken.address))) {
    await waitForTx(
    ...
    await saveInitConfiguration(stableDebtToken.address);
  }
  ...
  if (!(await getInitConfiguration(variableDebtToken.address))) {
    await waitForTx(
    ...
    await saveInitConfiguration(variableDebtToken.address);
  }
