...
export enum eAstarLayer2Network {
  main = "astar",
  zkatana = "zkatana",
}
...
export interface IAaveConfiguration extends ICommonConfiguration {
  ...
  // default to true, if disabled, will not deploy the incentives module: deploy/02_market/07_incentives.ts
  DisableIncentives?: boolean;
}
