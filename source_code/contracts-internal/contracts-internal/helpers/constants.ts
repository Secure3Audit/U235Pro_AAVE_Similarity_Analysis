...
export const WRAPPED_NATIVE_TOKEN_PER_NETWORK: { [network: string]: string } = {
  ...
  [eScrollNetwork.mainnet]: "0x5300000000000000000000000000000000000004",
};
...
export const chainlinkAggregatorProxy: Record<string, string> = {
  ...
  // mock
  [eAstarLayer2Network.zkatana]: "0xEA245346550141C347584176f34ac6Ea7235Caf6",
  // mock
  [eScrollNetwork.testnet]: "0xC073d1E7041DA89F0061Cc70cB0D483c89B1C38F",
  [eScrollNetwork.mainnet]: "0x6bF14CB0A831078629D993FDeBcB182b21A8774C",
};
...
// stores ERC20 tokens of an ecosystem reserve (i.e. interest differences)
export const POOL_ADMIN: Record<string, string> = {
  ...
  [eScrollNetwork.mainnet]: "0x8E9EF2dfC7a3fCdC9129410E6bF1bba25cd6918E", // multisig
  [eScrollNetwork.testnet]: "0x8E9EF2dfC7a3fCdC9129410E6bF1bba25cd6918E", // multisig not setup on testnet
};
...
export const DEFAULT_NAMED_ACCOUNTS = {
  // Can be transferrable to a multisig
  deployer: {
    default: 0,
  },
  aclAdmin: {
  ...
  // only usable if there are multiple markets within U235
  addressesProviderRegistryOwner: {
    default: 0,
  },
  // Not used for U235, given U235 doesn't support staking yet
  treasuryProxyAdmin: {
    default: 1,
  },
  // Not used for U235, given U235 doesn't support staking yet
