...
export const NETWORKS_RPC_URL: iParamsPerNetwork<string> = {
  ...
  [eEthereumNetwork.sepolia]: `https://ethereum-sepolia.publicnode.com`,
  [eArbitrumNetwork.goerliNitro]: `https://goerli-rollup.arbitrum.io/rpc`,
  [eAstarLayer2Network.zkatana]: `https://rpc.zkatana.gelato.digital`,
  // [eAstarLayer2Network.zkatana]: `https://rpc.startale.com/zkatana`,
  [eScrollNetwork.testnet]: `https://sepolia-rpc.scroll.io`,
  // [eScrollNetwork.mainnet]: `https://rpc.scroll.io`,
  [eScrollNetwork.mainnet]: `https://scroll.blockpi.network/v1/rpc/public`,
};
...
export const LIVE_NETWORKS: iParamsPerNetwork<boolean> = {
  ...
  [eAstarLayer2Network.main]: true,
  [eScrollNetwork.mainnet]: true,
};
